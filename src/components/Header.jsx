    ...
    return (
      ...
      <li>
          ...
          <li onMouseOver={handlePagesMouseOver}>
            <Link to="/">  PAGES <i style={{fontSize: "0.7em"}} class="fa-solid fa-chevron-down"></i></Link>
              {pagesIsMousedOver ? <SubMenuPages1 onMouseOverProps={handlePagesMouseOver}
                onMouseOutProps={handlePagesMouseOut}
              />: "" }
          </li>
          </div>
          <li onMouseOver={handlePagesMouseOut} >
            <Link to="/resourses" onMouseOver={handlePagesMouseOut}>RESOURCES</Link>
          </li>
          <li>
...
<div style={{visibility: menuBarIsClicked ? "visible": "hidden"}} class="toggle-menu-bar">
  ...
  <ul class="toggle-menu-bar-ul">
    ...
    <li onClick={handlePagesClick}>
      <Link>Pages {pagesIsClicked ? <i style={{fontSize: "0.7em"}} class="fa-solid fa-chevron-down"></i> :  <i style={{fontSize: "0.7em"}} class="fa-solid fa-chevron-right"></i> } </Link>
        {pagesIsClicked ? <SubMenuPages2 /> : "" }
    </li>
    <li onClick={handleResourcesClick}>
      <Link>Resources  {resourcesIsClicked ? <i style={{fontSize: "0.7em"}} class="fa-solid fa-chevron-down"></i> :  <i style={{fontSize: "0.7em"}} class="fa-solid fa-chevron-right"></i> } </Link>
