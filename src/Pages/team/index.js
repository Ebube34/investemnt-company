    ...
    <div className="bg-primary w-full overflow-hidden">
        ...
        <div className={`bg-primary ${styles.flexStart}`}>
          ...
          <h1
            ...
            <p style={{ paddingBottom: "5rem"}} className={styles.paragraph}>The investment team at QuivasFinance has the broad experience required to solve difficult problems and help build successful, sustainable businesses.</p>
            ...
            <div style={{ borderTop: "1px solid #46454C", borderBottom: "1px solid #46454C", padding: "1rem 1rem 2rem"}}>
              ...
              <p className={styles.paragraph2}>Joseph Kenneth is Chairman of QuivasFinance Investment Company, which he founded in 2007. <span style={{ color: "#1ACDC6", cursor: "pointer"}}> <Link to="/our-team/joseph-Kenneth">MORE {">"} </Link></span></p>
            ...
            <div style={{ borderTop: "1px solid #46454C", borderBottom: "1px solid #46454C", padding: "1rem 1rem 2rem"}}>
              ...
              <p className={styles.paragraph2}>Steffler N. Margaret is a Partner at QuivasFinance Investment Company and is responsible for certain portfolio companies. <span style={{ color: "#1ACDC6", cursor: "pointer"}}> <Link to="/our-team/steffler-margaret">MORE {">"} </Link></span></p>
            ...
            <div style={{ borderTop: "1px solid #46454C", borderBottom: "1px solid #46454C", padding: "1rem 1rem 2rem"}}>
              ...
              <p className={styles.paragraph2}>Bill William Richard is a Director of QuivasFinance Investment Company. He provides assistance to Newlin Investment Company with respect to advice concerning operations of certain portfolio companies. <span style={{ color: "#1ACDC6", cursor: "pointer"}}> <Link to="/our-team/bill-richard">MORE {">"} </Link></span></p>
            ...
            <div style={{ borderTop: "1px solid #46454C", borderBottom: "1px solid #46454C", padding: "1rem 1rem 3rem", marginBottom: "2rem" }}>
              ...
              <p className={styles.paragraph2}>Carl A. Anthony is the Controller of QuivasFinance Investment Company and is responsible for all traditional roles of a corporate controller. <span style={{ color: "#1ACDC6", cursor: "pointer"}}> <Link to="/our-team/carl-anthony">MORE {">"} </Link></span></p>
